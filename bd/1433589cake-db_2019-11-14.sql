...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 14 nov. 2019 à 17:18
...
INSERT INTO `files_products` (`product_id`, `file_id`) VALUES
(1, 1);
...
(20191109202243, 'Initial', '2019-11-10 01:22:44', '2019-11-10 01:22:44', 0),
(20191109202401, 'Initial2', '2019-11-10 01:24:02', '2019-11-10 01:24:02', 0),
(20191109203322, 'Initial', '2019-11-10 01:33:23', '2019-11-10 01:33:23', 0),
(20191109204020, 'Initial', '2019-11-10 01:40:22', '2019-11-10 01:40:22', 0);
...
(1, 1, 'Black T-shirt', 13, 'A Basic black T-shirt for everyday use', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
--
ALTER TABLE `adresse`
  ADD CONSTRAINT `adresse_ibfk_1` FOREIGN KEY (`categories_id`) REFERENCES `categories` (`id`),
  ADD CONSTRAINT `adresse_ibfk_2` FOREIGN KEY (`subcategories_id`) REFERENCES `subcategories` (`id`);
